  ...
  \begin{center}
    \begin{tikzpicture}[-,> = stealth',node distance=1.8cm, very thick]
      ...
      \visible<4>{
        ...
        % Git command
        \node[headline] (text_push) at (1,6) {\texttt{git push}};
      }
    \end{tikzpicture}
  \end{center}
\end{frame}
  ...
  \begin{center}
    \begin{tikzpicture}[-,> = stealth',node distance=1.8cm, very thick]
      ...
      \visible<3->{
        ...
        \node[headline] (text_cherry) at (3,6) {\texttt{git cherry-pick 8}};
        
        % New commit
        \node[commit] (8a) [right of=11] {8a};
        \path[arrow_commit] (11) -- (8a);
        \path[arrow_commit,->,uired, dotted] (highlight) -- (8a);
...
\begin{frame}[c]
  \begin{center}
    \begin{tikzpicture}[-,> = stealth',node distance=1.8cm, very thick]
      ...
      \visible<1>{
        % Remote master
        \node[branch_remote]  (master_remote) [above left of=6]  {origin/master};
        \path[arrow_branch] (6) -- (master_remote);
      }
      ...
      \visible<2->{
        % Commits from remote
        \node[commit3] (9) [above of=7] {9};
        \node[commit3] (10) [right of=9] {10};
        \path[arrow_commit] (6) -- (9);
        \path[arrow_commit] (9) -- (10);

        % Remote master
        \node[branch_remote]  (master_remote) [above right of=10]  {origin/master};
        \path[arrow_branch] (10) -- (master_remote);
      }
      
      \visible<2>{
        % Git fetch command
        \node[headline,anchor=west] (text_fetch) at (-1,4) {\texttt{git fetch}};
      }
      
      % After rebase
      \visible<3->{
        % Git fetch command
        \node[headline,anchor=west] (text_rebase)  at (-1,4) {\texttt{git rebase origin/master}};
        
        \node[commit] (9a) [right of=8] {9a};
        \node[commit] (10a) [right of=9a] {10a};
        \path[arrow_commit] (8) -- (9a);
        \path[arrow_commit] (9a) -- (10a);
      }
