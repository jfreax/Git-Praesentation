...
\tikzstyle{arrow_branch} = [draw,-,uigreen_dark,thick,dashed]
\tikzstyle{arrow_commit} = [draw,<-,uigreen_dark,very thick]
...
\begin{frame}[c]
  \begin{center}
    \begin{tikzpicture}[-,> = stealth',node distance=1.6cm, very thick]
      ...
      \visible<2->{
        \node[style={font=\sffamily\Large}] (branch_ref) at (-4,5) {Referenz};
        \path[<-,uigreen_dark,dotted,thick,shorten <= 8.0pt]
          (master.south) edge [bend left=10] (branch_ref.east);
      }
        
      % "Name" string and arrow
      \visible<3->{
        \node[style={font=\sffamily\Large}] (branch_name) at (3,3) {Name};
        \path[<-,uigreen_dark,dotted,thick,shorten <= 6.0pt]
          (master.center) edge [bend right=10] (branch_name.north);
      }
    \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}[c]
  \begin{center}
    \begin{tikzpicture}[-,> = stealth',node distance=1.4cm, very thick]
      \node[commit] (0)              {0}[anchor=north];
      \node[commit] (1) [above of=0] {1};
      \node[commit] (2) [above of=1] {2};
      \node[commit] (5) [above of=2] {5};
      \node[commit] (3) [right of=5,node distance=2.5cm] {3};
      \node[commit] (4) [right of=2,node distance=5cm] {4};
      \node[branch] (bugfix) [above of=4] {bugfix};
      \node[branch]  (featureX) [above of=3]  {featureX};
      
      \visible<1>{
        \node[branch]  (master) [above of=5]  {master};
      }
      ...
      \path[arrow_branch] (3) -- (featureX);
      \path[arrow_branch] (4) -- (bugfix);
      
      % More than one parent
      \visible<2->{
        \node[commit] (6) [above of=5] {6};
        \node[branch]  (master) [above of=6]  {master};
