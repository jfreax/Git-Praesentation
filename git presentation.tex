...
\begin{frame}[c]
  \begin{columns}
    ...
    \begin{tikzpicture}[%
      ...
      \node[main node] (0)              {0}[anchor=north];
      ...
      \draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=20pt},yshift=0pt]
(0)[anchor=north] -- (3) node [black,midway,xshift=1.4cm] {$P_2$};
    \end{tikzpicture}
